...
message = 'boop'    # original message here
legit = '346091b67e07d97536f9e16a3324d162'      # a legit hash of secret + message goes here, obtained from signing a message
...
malicious = 'snoot'  # put your malicious message here
...
padding = '\x70\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x50\x00\x00\x00\x00\x00\x00\x00'
...
#                     = fake_hash
print(len(padding.encode('utf-8')))
